export const Footer = () => {
  return (
    <footer className="bg-white p-10 font-sans tracking-wide">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <li>
              <a href="#">
                <svg
                  ...
                  className="fill-butttext-buttonBackground hover:fill-buttonBackground w-7 h-7"
                  viewBox="0 0 24 24"
                >
                  <path
                    fillRule="evenodd"
        ...
        <div>
          <h4 className="text-lg font-semibold mb-6 text-buttonHover">
            Contact Us
          </h4>
          <ul className="space-y-4">
            <li>
              <a
                href="#"
                className="text-buttonBackground hover:text-buttonHover text-sm"
              >
                Email
              </a>
            </li>
      ...
      <p className="text-buttonBackground text-sm mt-10">
        © Ludis. All rights reserved.
      </p>
    </footer>
  );
};
